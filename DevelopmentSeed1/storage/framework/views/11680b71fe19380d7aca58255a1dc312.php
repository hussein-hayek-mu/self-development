...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6 bg-[#12121a]">
            <?php echo csrf_field(); ?>
            ...
            <p class="text-sm text-gray-400 mb-6">
                All your progress (Level <?php echo e(auth()->user()->level ?? 1); ?>, <?php echo e(number_format(auth()->user()->total_xp ?? 0)); ?> XP) will be permanently lost. Enter your password to confirm.
            </p>
...
<?php /**PATH /Users/root1/Desktop/U/Github/Self_Dev/self-development/DevelopmentSeedBlade/resources/views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>