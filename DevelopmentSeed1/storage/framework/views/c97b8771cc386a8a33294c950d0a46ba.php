...
<head>
    ...
    <title>Admin - <?php echo e(config('app.name', 'Level Up')); ?></title>
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-[#0a0a0f]">
        ...
        <aside class="sidebar fixed left-0 top-0 h-full z-50">
            <!-- Logo -->
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-6 py-6 border-b border-gray-800">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="<?php echo e(route('admin.habits.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.habits.*') ? 'active' : ''); ?>">
                    <span>🎯</span>
                    <span>Habits</span>
                </a>
                <a href="<?php echo e(route('admin.quests.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.quests.*') ? 'active' : ''); ?>">
                    <span>⚔️</span>
                    <span>Quests</span>
                </a>
...
<?php /**PATH /Users/root1/Desktop/U/Github/Self_Dev/self-development/DevelopmentSeedBlade/resources/views/components/admin-layout.blade.php ENDPATH**/ ?>