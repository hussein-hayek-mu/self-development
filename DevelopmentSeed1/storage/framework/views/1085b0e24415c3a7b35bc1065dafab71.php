...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="mb-4">
            ...
            <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-input" required autofocus autocomplete="name" placeholder="Enter your hero name" />
...
<?php endif; ?>
        ...
        <div class="mb-4">
            ...
            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-input" required autocomplete="username" placeholder="your@email.com" />
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
    ...
    <p class="text-center text-gray-400 text-sm mt-6">
        ...
        <a href="<?php echo e(route('login')); ?>" class="text-purple-400 hover:text-purple-300">Login</a>
    </p>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/root1/Desktop/U/Github/Self_Dev/self-development/DevelopmentSeedBlade/resources/views/auth/register.blade.php ENDPATH**/ ?>