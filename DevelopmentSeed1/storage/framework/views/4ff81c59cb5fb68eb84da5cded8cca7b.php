    ...
    <section class="min-h-screen flex items-center justify-center text-center px-6 pt-20">
        <div class="max-w-4xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary text-lg px-8 py-4">Go to Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary text-lg px-8 py-4 animate-pulse-glow">Start Your Journey</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn-secondary text-lg px-8 py-4">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="game-card text-center hover:scale-105 transform transition-transform">
                    ...
                    <h3 class="text-xl font-bold mb-3"><?php echo e($feature['title']); ?></h3>
                    <p class="text-gray-400"><?php echo e($feature['description']); ?></p>
                </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center gap-4 p-4 bg-purple-500/10 rounded-lg">
                        ...
                        <div>
                            ...
                            <div class="text-white"><?php echo e($contact['email']); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 bg-purple-500/10 rounded-lg">
                        <span class="text-2xl">💬</span>
                        <div>
                            ...
                            <div class="text-white"><?php echo e($contact['discord']); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 bg-purple-500/10 rounded-lg">
                        <span class="text-2xl">🐦</span>
                        <div>
                            ...
                            <div class="text-white"><?php echo e($contact['twitter']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /Users/root1/Desktop/U/Github/Self_Dev/self-development/DevelopmentSeedBlade/resources/views/home.blade.php ENDPATH**/ ?>