...
class UserManagementController extends Controller
{
    ...
    public function show(User $user): Response
    {
        ...
        $userStats = [
            ...
            'completedHabitsToday' => $user->habits->where('completed_today', true)->count(),
            'totalQuests' => $user->quests->count(),
            'completedQuests' => $user->quests->where('completed', true)->count(),
            'longestStreak' => $user->habits->max('streak') ?? 0,
        ];
